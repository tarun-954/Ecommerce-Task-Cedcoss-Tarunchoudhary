...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Customer detail dashboard with reviews, ratings and AI analysis." },
    ],
    links: [
...
function Star({ className = "w-5 h-5", filled = true }: { className?: string; filled?: boolean }) {
  return (
    <svg className={`${className} ${filled ? "text-yellow-400" : "text-gray-200"} fill-current`} viewBox="0 0 20 20">
...
function CustomerDetailPage() {
  type Review = { id: string; order: string; stars: number; published: boolean; item: string; text: string; author: string; avatar: string };
  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      stars: 5,
      published: true,
      item: 'Acer Aspire 5 Spin 14" AS5P14-51MTN',
      text: "I'm impressed! 🔥 The sleek design and 360-degree hinge make it super versatile. The 14-inch Full HD touchscreen is responsive with vibrant colors...",
  ...
  const [draft, setDraft] = useState({ order: "", item: "", text: "", stars: 5, publish: true, author: "", avatar: "" });
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setDraft({ order: "", item: "", text: "", stars: 5, publish: true, author: "", avatar: "" });
    setShowForm(false);
  };


  return (
    <div className="min-h-screen bg-gray-100 p-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <style>{`
        .ai-card-gradient { background: linear-gradient(90deg, #f5f3ff 0%, #faebff 100%); }
      `}</style>
      <div
        className="mx-auto flex bg-white overflow-hidden"
        style={{ maxWidth: 1440, borderRadius: 24, boxShadow: "0 25px 50px -12px rgba(0,0,0,0.1)", minHeight: 900 }}
      >
        {/* Left sidebar */}
        <aside className="w-16 flex-none border-r border-gray-100 flex flex-col items-center py-6 space-y-8 bg-white">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold" style={{ backgroundColor: BRAND }}>
            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z" /></svg>
          </div>
          <button className="w-10 h-10 rounded-lg flex items-center justify-center text-white" style={{ backgroundColor: BRAND }}>
            <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 4v16m8-8H4" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /></svg>
          </button>
          <nav className="flex flex-col space-y-4">
            {[
              ...
              <a key={i} href="#" className="p-2 text-gray-400 hover:text-[color:var(--brand)]" style={{ ["--brand" as never]: BRAND }}>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white">
          ...
          <header className="h-16 flex items-center justify-between px-8 border-b border-gray-100 flex-none">
            <div className="flex items-center space-x-2 text-sm">
              <span className="text-gray-900 font-semibold">Fikri Store</span>
            ...
            <div className="flex-1 max-w-xl px-8">
              <div className="relative">
                ...
                <input className="block w-full pl-10 pr-3 py-2 border-0 bg-gray-50 rounded-lg text-sm focus:bg-white outline-none" placeholder="Search or Press '/' for commands" type="text" />
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="w-8 h-8 rounded-full bg-blue-900 flex items-center justify-center text-xs text-white font-bold">FIK</div>
            </div>
          </header>
          ...
          <div className="flex-1 flex overflow-hidden">
            <main className="flex-1 overflow-y-auto p-8">
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-6">
                  <button className="p-2 border border-gray-100 rounded-lg hover:bg-gray-50">
                    <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M15 19l-7-7 7-7" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /></svg>
                  </button>
                  <img
                    alt="Brooklyn Simmons"
                    className="w-20 h-20 rounded-full object-cover"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBFCvwytqibzlFdHubko_JJGsym03sxWXWb24dOH0Y1s9a6lzcEuw_mFF34PWk-Wj7Sp5J9ZS5V2nClJpQmo6-fgLeLzzNgRoSU3A3toDUooTI9ETmsXA7NbsLDzIEGMCL0cw0igSBb_ovd1U5PlQOrwqtzvlExeKKkXvN_T7bsgEu7Pf5s6KVfuHv9AfT-J5ryp8y6lJ9zi9a4SS1nEqklBeAPZfG7FiRjnBGbMVEG-G_JJtpgv88SqTaG9h2d3La7W4jNr56jlwo"
                  />
                  <div>
                    <h1 className="text-3xl font-bold text-gray-900">Brooklyn Simmons</h1>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex border border-gray-200 rounded-lg overflow-hidden">
                    <button className="px-2 py-2 hover:bg-gray-50 border-r border-gray-200"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg></button>
                    <button className="px-2 py-2 hover:bg-gray-50"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></button>
                  </div>
                </div>
              </div>
              ...
              <div className="border-b border-gray-100 mb-8">
                <nav className="flex space-x-8">
                  {["Purchase History", "Wishlist", "Review", "Loyalty Program", "Support ticket", "Insight", "Activity"].map((t) => {
              ...
              <div className="ai-card-gradient rounded-xl p-6 flex items-start space-x-6 border border-purple-50 mb-10">
                <div className="bg-white/50 p-4 rounded-lg flex flex-col items-center">
                  <div className="text-purple-600 mb-1">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.49l-2.33-2.33 2.15-2.15 2.33 2.33-2.15 2.15z" /></svg>
                  </div>
                  <span className="text-[10px] font-bold text-purple-700 text-center leading-tight">AI Review<br />Analysis</span>
                </div>
                <div className="flex-1">
                  <h3 className="font-bold text-gray-900 text-lg">Customer are satisfied</h3>
                  <p className="text-gray-600 text-sm mt-1 leading-relaxed">The customer was satisfied with the product, noting its quality, durability, and quick, helpful support.</p>
                </div>
                <div className="relative">
                  <div className="bg-white/80 p-3 rounded-xl shadow-sm">
                    <svg className="w-8 h-8 text-purple-500" fill="currentColor" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 11H7V9h2v2zm4 0h-2V9h2v2zm4 0h-2V9h2v2z" /></svg>
                  </div>
                  <div className="absolute -top-1 -right-1 bg-white rounded-full p-0.5">
                    <svg className="w-4 h-4" style={{ color: BRAND }} fill="currentColor" viewBox="0 0 24 24"><path d="M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-2z" /></svg>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 mb-8">
                <div className="relative w-64">
                  ...
                  <input className="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg text-sm bg-gray-50 focus:bg-white outline-none" placeholder="Search" />
                </div>
                <button className="px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium flex items-center space-x-2 hover:bg-gray-50">
                  <span>Duration</span><ChevronDown />
                </button>
                <button className="px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium flex items-center space-x-2 hover:bg-gray-50">
                  <span>Channels</span><ChevronDown />
                </button>
                <button
                  ...
                  <div className="flex items-center space-x-4">
                    <label className="cursor-pointer relative shrink-0">
                      <div
                        ...
                        style={draft.avatar ? { backgroundImage: `url(${draft.avatar})`, backgroundSize: "cover", backgroundPosition: "center", borderStyle: "solid" } : undefined}
                      >
                        {!draft.avatar && (
                  ...
                  {[
                    ...
                    <div key={r.label} className="flex items-center text-xs">
                      ...
                      <div className="flex-1 mx-3 relative h-1.5 rounded-full bg-gray-200">
                        <div className="absolute inset-y-0 left-0 rounded-full bg-gray-900" style={{ width: `${r.pct}%` }} />
                      </div>
            ...
            <aside className="w-80 flex-none border-l border-gray-100 overflow-y-auto bg-white">
              <div className="p-6 border-b border-gray-100">
                <h4 className="text-sm font-bold text-gray-900 mb-4 pb-2 border-b-2 border-black inline-block">Customer Details</h4>
              ...
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="text-gray-400"><EditIcon /></button>
                </div>
                <div className="relative w-full h-24 bg-gray-100 rounded-lg overflow-hidden mb-4 border border-gray-200">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-3 h-3 rounded-full border-2 border-white" style={{ backgroundColor: BRAND, boxShadow: `0 0 0 4px ${BRAND}33` }} />
                  </div>
                </div>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                      2118 Thornridge Cir. Syracuse,<br />Connecticut 35624<br />United State
                    </p>
                  </div>
                  <a className="text-[10px] font-bold text-gray-900 underline" href="#">View on Map</a>
                </div>
              </div>
              ...
              <div className="p-6 border-b border-gray-100">
                ...
                <div className="space-y-3">
                  <div className="inline-flex px-3 py-1.5 rounded-lg border border-blue-200 bg-blue-50 text-xs font-medium text-blue-700">bagus.fikri@mail.com</div>
                  <div className="block">
                    <div className="inline-flex px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-50 text-xs font-medium text-gray-700">+(22)-789-907</div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 border-b border-gray-100">
                ...
                <div className="inline-flex px-3 py-1.5 rounded-lg border border-blue-200 bg-blue-50 text-xs font-medium text-blue-700">Business Owner</div>
              </div>
...
function ReviewItem({ order, stars, published, item, text, author, avatar }: { order: string; stars: number; published: boolean; item: string; text: string; author: string; avatar: string }) {
  return (
    <div className="border-t border-gray-100 pt-8 pb-12">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center space-x-3">
          <img src={avatar} alt={author} className="w-10 h-10 rounded-full object-cover border border-gray-100" />
          <div className="flex flex-col">
            ...
            <div className="flex items-center space-x-2 mt-0.5">
              ...
              <button className="text-gray-400 hover:text-gray-600"><CopyIcon /></button>
              <div className="flex">
                {Array.from({ length: 5 }).map((_, i) => <Star key={i} className="w-3.5 h-3.5" filled={i < stars} />)}
              </div>
            </div>
          </div>
        </div>
        {published ? (
          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-green-100 text-green-700">
            <svg className="w-2.5 h-2.5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" /></svg>
            Published
          </span>
        ) : (
          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-gray-100 text-gray-500">
            <svg className="w-2.5 h-2.5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" clipRule="evenodd" d="M13.477 3.03a.75.75 0 01.437.695v8.68a.75.75 0 01-1.076.676l-1.872-.936a.75.75 0 00-.67 0l-1.872.936a.75.75 0 01-1.076-.676V3.725a.75.75 0 01.437-.695 38.014 38.014 0 017.692 0zM10 10.75a.75.75 0 100-1.5.75.75 0 000 1.5z" /></svg>
            Unpublished
          </span>
        )}
      </div>
      <div className="mb-3">
        <span className="text-sm mr-2 font-bold" style={{ color: BRAND }}>|</span>
        <span className="text-sm text-gray-500 mr-2">Item:</span>
        <a className="text-sm font-semibold underline underline-offset-2" href="#">{item}</a>
      </div>
...
type PHReview = { id: string; author: string; avatar: string; date: string; stars: number; text: string; helpful: number };
...
function usePurchaseHistoryState() {
  ...
  return { list, subTab, setSubTab, rating, setRating, hover, setHover, title, setTitle, feedback, setFeedback, submit };
}
  ...
  return (
    <div>
      <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
        <a className="hover:text-[color:var(--brand)]" style={{ ["--brand" as never]: BRAND }} href="#">Dashboard</a>
        <span>/</span>
      ...
      <p className="text-sm text-gray-500 mb-6">Review your recent purchase and share your experience with the community.</p>
      ...
      <section className="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden mb-8">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/3 bg-[#fff1eb] p-6 flex items-center justify-center">
            <img src={PRODUCT_IMG} alt="Plushie Aya Bunny" className="max-w-full max-h-56 object-contain drop-shadow-xl" />
          </div>
          <div className="flex-1 p-6">
            <div className="flex justify-between items-start mb-4">
              <div>
                <span className="bg-sky-400 text-white px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wide mb-2 inline-block">Purchased</span>
                <h3 className="text-2xl font-bold" style={{ color: BRAND }}>Plushie Aya Bunny</h3>
              </div>
            ...
            <div className="grid grid-cols-2 gap-y-4 mb-6">
              <div><p className="text-[11px] uppercase tracking-wide text-gray-500">Color</p><p className="text-sm font-semibold">Creamy White</p></div>
              <div><p className="text-[11px] uppercase tracking-wide text-gray-500">Order Date</p><p className="text-sm font-semibold">Oct 12, 2023</p></div>
              <div><p className="text-[11px] uppercase tracking-wide text-gray-500">Order ID</p><p className="text-sm font-semibold">#SaaS-88219</p></div>
              <div>
            ...
            <div className="flex gap-3">
              <button className="text-white px-5 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 hover:opacity-90" style={{ backgroundColor: BRAND }}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                Write a Review
              </button>
              <button className="border border-gray-300 px-5 py-2.5 rounded-lg text-sm font-bold hover:bg-gray-50">Buy Again</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <>
          <div className="bg-white/60 backdrop-blur p-4 rounded-xl mb-6 flex items-center gap-4 border border-gray-100 shadow-sm">
            <div className="w-10 h-10 bg-sky-100 text-sky-600 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l1.9 5.9H20l-4.9 3.6L17 17l-5-3.6L7 17l1.9-5.5L4 7.9h6.1L12 2z" /></svg>
            </div>
            <div className="flex-1">
              <p className="text-sm font-bold text-gray-900">AI Review Analysis</p>
              <p className="text-xs text-gray-600">"The customer was satisfied with the product, noting its quality, durability, and quick, helpful support."</p>
            </div>
            <div className="bg-white/80 p-2 rounded-lg border border-gray-200">
              <svg className="w-5 h-5" style={{ color: BRAND }} fill="currentColor" viewBox="0 0 24 24"><path d="M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-2z" /></svg>
            </div>
          </div>
            ...
            {list.map((r) => (
              <article key={r.id} className="bg-white p-5 rounded-xl border border-gray-200">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="bg-emerald-100 text-emerald-700 text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded">Verified Purchase</span>
                </div>
                <p className="text-sm text-gray-800 leading-relaxed mb-3">{r.text}</p>
                <div className="flex gap-5 text-xs font-bold text-gray-500">
                  <button className="flex items-center gap-1.5 hover:text-[color:var(--brand)]" style={{ ["--brand" as never]: BRAND }}>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 9V5a3 3 0 00-3-3l-4 9v11h11.28a2 2 0 002-1.7l1.38-9a2 2 0 00-2-2.3zM7 22H4a2 2 0 01-2-2v-7a2 2 0 012-2h3" /></svg>
                    Helpful ({r.helpful})
                  </button>
                  <button className="flex items-center gap-1.5 hover:text-[color:var(--brand)]" style={{ ["--brand" as never]: BRAND }}>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.8L3 21l1.8-4.5A8.36 8.36 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                    Reply
                  </button>
                </div>
              </article>
          ...
          <div className="mt-6 text-center">
            <button className="text-sm font-bold hover:underline" style={{ color: BRAND }}>View All 1,543 Reviews</button>
          </div>
        </>
      )}
...
function PurchaseHistorySidebar({ state }: { state: PHState }) {
  const { rating, setRating, hover, setHover, title, setTitle, feedback, setFeedback, submit } = state;
  const bars = [
  ...
  return (
    <>
      <div className="p-6 border-b border-gray-100">
        <h4 className="text-sm font-bold text-gray-900 mb-4 pb-2 border-b-2 border-black inline-block">Customer Sentiment</h4>
        <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
          <div className="flex items-baseline gap-2 mb-4">
            <span className="text-4xl font-bold">4.5</span>
            <div className="flex flex-col">
              <div className="flex" style={{ color: BRAND }}>
                {Array.from({ length: 4 }).map((_, i) => <Star key={i} className="w-4 h-4" filled />)}
            ...
            {bars.map((b) => (
              <div key={b.label} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-white rounded-full overflow-hidden border border-gray-100">
                  <div className="h-full rounded-full" style={{ width: `${b.pct}%`, backgroundColor: BRAND }} />
                </div>
      ...
      <div className="p-6 border-b border-gray-100">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <label className="text-[11px] uppercase tracking-wide text-gray-500 block mb-2">Select Rating</label>
          ...
          <div>
            <label className="text-[11px] uppercase tracking-wide text-gray-500 block mb-1">Review Title</label>
            <input
              value={title}
          ...
          <div>
            <label className="text-[11px] uppercase tracking-wide text-gray-500 block mb-1">Your Feedback</label>
            <textarea
              value={feedback}
      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-3">
          ...
          <a href="#" className="text-xs font-bold" style={{ color: BRAND }}>View All</a>
        </div>
        <div className="space-y-2">
          {[
            { name: 'MacBook Pro 14" M1 Chip', date: "Ordered Dec 20, 2023", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCUw_WKKKXOlKISiAkEugxg1OM76IvAGriYjPFgAoCpZQX1jCkSisFBet--PWMcBkSaaU3AZyyZvWcyg7KYtNaYMMlzHjHzRzaEm57Zu524E84C5jb4m6_HLONYKT7Q-Fsw_2ZCDvwYSWOFT03yYTp8CSEJXWVlE3UlAIPDrPve4oeHPsxNoJ3fArC8xqew5U1KAOkSSy7nGa7d7dSYc6nJu7EkbhrhRFlqycLq-vPE5fNn7myx2xV9xEZylJuYtXHdGK6K1ktfPks" },
            { name: "Classic Leather Timepiece", date: "Ordered Nov 05, 2023", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCsV5xn7Kfr9ik934UtNOUFbbqASAmkpo7JnDVR4yPejeDChFFYXzXKzJ7OJmJ5eZsklN2LHux_eOhETMNc85vWIMGyYtbfL9IP20Ifiu3rkYRYQ_928jxgNOP6JcVZZYwcLdtmQfLprlkEh-6YKY4HwUUvdAYA5DXufWXwruVuPjC-oizGkMhOO81H5SOvBMhIEaX1gy_-VsYykdJGL13l26ODW3Qy35P4TBNpOtVDT2RwZyfAUhKug63T8sJtbv-81r6Eda2pgtY" },
          ].map((p) => (
            <div key={p.name} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 cursor-pointer border border-transparent hover:border-gray-200">
